...
public class CommandManagerTest {
    ...
    public void testCommands() throws NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        CommandProtocol profile1 = new CommandProtocol(new User("u"), new CommandLine(), new YahooFinanceStockAPI(), new String[]{"buy", "sell", "checkprice"});
        CommandProtocol profile2 = new CommandProtocol(new User("u"), new CommandLine(), new YahooFinanceStockAPI(), null);
